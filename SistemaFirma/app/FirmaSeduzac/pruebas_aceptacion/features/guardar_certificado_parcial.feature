Característica: Guardar Datos de Certificacion Total
    ...
    Escenario: Datos guardados correctamente
        ...
        Y selecciono del menu la opción de Certificaciones Parciales
        Y selecciono la opción de Nuevo certificado Parcial
        ...
        Y escribo la fecha de certificacion "24/07/2024"
        Y escribo el semestre "4"
